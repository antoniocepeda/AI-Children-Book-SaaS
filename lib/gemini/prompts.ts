...
You must output strict, valid JSON only. No markdown formatting, no commentary, no code blocks.
...
CRITICAL: You must include exactly 11 page objects with pageNumbers 0 through 10.
